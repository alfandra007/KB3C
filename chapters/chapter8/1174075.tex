...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174075/figures8/1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174075/figures8/2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174075/figures8/3a.png}
	\caption{gambar arsitektur generator pada GAN-Project}
\end{figure}
untuk ilustrasinya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174075/figures8/3.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174075/figures8/4a.png}
	\caption{gambar arsitektur generator pada GAN-Project}
\end{figure}
untuk ilustrasinya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174075/figures8/4.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174075/figures8/5.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figures/1174075/figures8/6.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figures/1174075/figures8/7.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figures/1174075/figures8/8.png}
...
\lstinputlisting[firstline=8, lastline=20, caption={Kode program arsitektur generator},captionpos=b]{src/1174075/8/teori.py}
...
\lstinputlisting[firstline=23, lastline=35, caption={Kode program arsitektur diskriminator},captionpos=b]{src/1174075/8/teori.py}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figures/1174075/figures8/9.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/1174075/figures8/p1.png}
...
\hfill\\
\lstinputlisting[firstline=31, lastline=61]{src/1174075/8/run.py}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/1174075/figures8/3a.png}
...
\hfill\\
\lstinputlisting[firstline=64, lastline=102]{src/1174075/8/run.py}
kode diatas merupakan diskriminator network, dimana prosesnya dapat digambarkan seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/1174075/figures8/4a.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/1174075/figures8/p6.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174075/figures8/p7.png}
...
\hfill\\
\lstinputlisting[firstline=8, lastline=23]{src/1174075/8/praktek.py}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/1174075/figures8/flower_pot.png}
...
\hfill\\
\lstinputlisting[firstline=35, lastline=41]{src/1174075/8/run.py}
potongan kode diatas berfungsi sebagai penentuan nilai untuk hyperparameters yang berbeda.
\lstinputlisting[firstline=43, lastline=43]{src/1174075/8/run.py}
potongan kode diatas berfungsi untuk membuat input layer
\lstinputlisting[firstline=45, lastline=50]{src/1174075/8/run.py}
potongan kode diatas berfungsi untuk menambahkan 3D transpose pertama.
\lstinputlisting[firstline=52, lastline=58]{src/1174075/8/run.py}
potongan kode diatas berfungsi untuk menambahkan empat 3D transpose lainya.
\lstinputlisting[firstline=60, lastline=60]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=68, lastline=74]{src/1174075/8/run.py}
potongan kode diatas berfungsi sebagai penentuan nilai untuk hyperparameters yang berbeda.
\lstinputlisting[firstline=78, lastline=78]{src/1174075/8/run.py}
potongan kode diatas berfungsi untuk membuat input layer, berupa gambar 3D dengan dimensi 64x64x64x1
\lstinputlisting[firstline=80, lastline=86]{src/1174075/8/run.py}
potongan kode diatas berfungsi untuk menambahkan 3D transpose pertama.
\lstinputlisting[firstline=88, lastline=98]{src/1174075/8/run.py}
potongan kode diatas berfungsi untuk menambahkan empat 3D transpose lainya.
\lstinputlisting[firstline=100, lastline=100]{src/1174075/8/run.py}
potongan kode diatas berfungsi untuk membuat model keras dan menentukan input dan output untuk network generator.

\subsubsection{jelaskan apa maksud dari kode program name == ' main '}
\hfill\\
\lstinputlisting[firstline=153, lastline=153, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=173, lastline=180, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=182, lastline=189, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=191, lastline=195, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=197, lastline=200, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
Penjelasan kode:
\lstinputlisting[firstline=202, lastline=204, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=206, lastline=212, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=214, lastline=218, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=220, lastline=222, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=224, lastline=226, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=232, lastline=242, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=256, lastline=265, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=267, lastline=270, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=276, lastline=278, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\hfill\\
\lstinputlisting[firstline=287, lastline=298, caption={Kode program run.py},captionpos=b]{src/1174075/8/run.py}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/1174075/8/error1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/1174075/8/s1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174075/8/plagiarisme1.png}
	\includegraphics[width=12cm]{figures/1174075/8/plagiarisme2.png}
