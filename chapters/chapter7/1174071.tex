...
\begin{enumerate}
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/3.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/4.png}
		\centering
	...
	Jelaskan apa maksud dari fungsi \emph{tokenizer = Tokenizer(num\_words=2000)} dan \emph{tokenizer.fit\_on\_texts(train\_content)}, dilengkapi dengan ilustrasi atau gambar.
		...
		\end{itemize}
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/5.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/6.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/7.png}
		\centering
		\caption{Illustrasi d train inputs}
	\end{figure}
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/8.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/9.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174071/7/10.png}
		\centering
...
\lstinputlisting[firstline=8, lastline=14]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=16, lastline=39]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=41, lastline=51]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=53, lastline=63]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=65, lastline=69]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=71, lastline=76]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=78, lastline=84]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=86, lastline=98]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=100, lastline=106]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=108, lastline=132]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=134, lastline=138]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=140, lastline=152]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=154, lastline=209]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=211, lastline=233]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=235, lastline=241]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=243, lastline=245]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=247, lastline=249]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=251, lastline=258]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=260, lastline=280]{src/1174071/7/1174071.py}
...
\lstinputlisting[firstline=282, lastline=288]{src/1174071/7/1174071.py}
\end{enumerate}
