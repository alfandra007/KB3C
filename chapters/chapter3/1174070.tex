...
\subsubsection{Jelaskan cara membaca dataset kasus dan artikan makna setiap ﬁle dan isi ﬁeld masing masing ﬁle.}
\hfill\\
...
\hfill\\
	...
	\hfill\\
	\lstinputlisting[firstline=8, lastline=11]{src/1174070/src3/1174070.py}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174070/figures3/2.png}
...
\hfill\\
Itu merupakan presentase keakurasian prediksi yang dilakukan pada saat testing menggunakan label pada dataset yang digunakan. Score merupakan mendeﬁnisikan aturan evaluasi model. Maka pada saat dijalankan akan muncuk persentase tersebut yang menunjukan keakurasian atau keberhasilan dari prediksi yang dilakukan. Jika menggunakan Random Forest maka hasilnya 40\% , jika menggunakan Decission Tree hasil prediksinya yaitu 27\% dan pada SVM 29\% .
...
\lstinputlisting[firstline=14, lastline=32]{src/1174070/src3/1174070.py}
\end{itemize}
Hasil dari kode diatas akan menghasilkan confusion matrix seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics{figures/1174070/figures3/4.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174070/figures3/5.png}
	\caption{contoh 9 hasil decision tree yang berbeda}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=6cm]{figures/1174070/figures3/6.png}
	\caption{contoh random forest}
\end{figure}
...
\lstinputlisting[firstline=8, lastline=14]{src/1174070/src3/praktek1.py}
...
\item Variabel d dideﬁnisikan sebagai data. data untuk col1, col2, dan col3.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6cm]{figures/1174070/figures3/7.png}
...
\lstinputlisting[firstline=16, lastline=20]{src/1174070/src3/praktek1.py}
Dari code diatas dapat dijelaskan perbarisnya sebagai berikut : 
\begin{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6cm]{figures/1174070/figures3/8.png}
...
\lstinputlisting[firstline=23, lastline=28]{src/1174070/src3/praktek1.py}
Dari code diatas dapat dijelaskan perbarisnya sebagai berikut : 
\begin{itemize}
...
\item plt.show() digunakan untuk menampilkan graﬁk pada saat skrip dijalankan. 
\end{itemize}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174070/figures3/9.png}
	\caption{contoh aplikasi sederhana menggunakan matplotlib}
\end{figure}

\subsubsection{jalankan program klasiﬁkasi Random Fores pada bagian teori bab ini. Tunjukkan keluarannya dari komputer sendiri dan artikan maksud setiap luaran yang didapatkan.}
\hfill\\
Pertama dataset kita baca terlebih dahulu. 
\lstinputlisting[firstline=7, lastline=12, caption={Membaca data file txt},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174070/figures3/10.png}
	\caption{Hasil dari listing 3.1}
\end{figure}

Melihat sebagian data awal, dengan menggunakan listing 3.2
\lstinputlisting[firstline=16, lastline=16, caption={Melihat sebagian data(bagian awal)},captionpos=b]{src/1174070/src3/bird-identifier.py} 
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=4cm]{figures/1174070/figures3/11.png}
	\caption{Hasil dari listing 3.2}
\end{figure}

Melihat jumlah data menggunakan listing 3.3
\lstinputlisting[firstline=20, lastline=20, caption={Mengetahui jumlah data},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=4cm]{figures/1174070/figures3/12.png}
...
\lstinputlisting[linerange={24-24,28-28,32-32}, caption={Pivot dataset},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figures/1174070/figures3/13.png}
	\includegraphics[width=12cm]{figures/1174070/figures3/13a.png}
	\includegraphics{figures/1174070/figures3/13b.png}
...
\lstinputlisting[linerange={36-39,43-43,47-47}, caption={Membaca dataset label file txt},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics{figures/1174070/figures3/14.png}
	\includegraphics{figures/1174070/figures3/14a.png}
	\includegraphics{figures/1174070/figures3/14b.png}
...
\lstinputlisting[linerange={51-52}, caption={Menggabungkan field dari dua file terpisah},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figures/1174070/figures3/15.png}
...
\lstinputlisting[linerange={56-57}, caption={Memisahkan dan memilih label},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figures/1174070/figures3/16.png}
	\caption{Hasil dari listing 3.7}
\end{figure}

Kita bisa mengecek isinya dengan perintah listing 3.8
\lstinputlisting[linerange={61-61,65-65}, caption={Melihat isi masing-masing dataframe},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174070/figures3/17.png}
	\includegraphics{figures/1174070/figures3/17a.png}
...
\lstinputlisting[linerange={69-75}, caption={Pembagian data training dan test},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174070/figures3/18.png}
	\caption{Hasil dari listing 3.9}
\end{figure}

Kita panggil kelas RandomForestClassiﬁer. max features diartikan sebagai berapa banyak kolom pada setiap tree dengan perintah listing 3.10
\lstinputlisting[linerange={79-80}, caption={Pembagian data training dan testInstansiasi kelas Random Forest},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174070/figures3/19.png}
	\caption{Hasil dari listing 3.10}
\end{figure}

Kemudian lakukan ﬁt untuk membangun random forest yang sudah ditentukan dengan maksimum ﬁtur sebanya 50 untuk perpohonnya dengan perintah listing 3.11
\lstinputlisting[linerange={84-84}, caption={Fitting random forest dengan dataset training},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/1174070/figures3/20.png}
	\caption{Hasil dari listing 3.11}
\end{figure}

Hasilnya bisa kita dapatkan dengan perintah predict dengan perintah listing 3.12
\lstinputlisting[linerange={88-88}, caption={Melihat Hasil prediksi},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
	\includegraphics{figures/1174070/figures3/21.png}
	\caption{Hasil dari listing 3.12}
\end{figure}

Untuk besaran akurasinya dengan perintah listing 3.13
\lstinputlisting[linerange={92-92}, caption={Score perolehan dari klasiﬁkasi},captionpos=b]{src/1174083/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={96-98,102-102}, caption={Membuat Confusion Matrix},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={106-136}, caption={Plotting Confusion Matrix},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={140-143}, caption={Membaca ﬁle classes.txt},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
Lalu kita plot
\lstinputlisting[linerange={147-151}, caption={Plot hasil perubahan label},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\subsubsection{jalankan program klasiﬁkasi SVM dan Decission Tree pada bagian teori bab ini. Tunjukkan keluarannya dari komputer sendiri dan artikan maksud setiap luaran yang didapatkan.}
\hfill\\
Kita coba menggunakan Decission tree
\lstinputlisting[linerange={155-158}, caption={Mencoba klasiﬁkasi dengan decission tree dengan dataset yang sama},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={162-165}, caption={Mencoba klasiﬁkasi dengan SVM dengan dataset yang sama},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={169-172}, caption={Hasil Cross Validation random forest},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={176-177}, caption={Hasil Cross Validation Random Forest},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
untuk SVM
\lstinputlisting[linerange={181-182}, caption={Hasil Cross Validation SVM},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={186-199}, caption={Melakukan Pengamatan komponen informasi},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
...
\lstinputlisting[linerange={203-217}, caption={Plot Komponen informasi agar bisa dibaca},captionpos=b]{src/1174070/src3/bird-identifier.py}
Hasilnya seperti berikut:
\begin{figure}[H]
	\centering
