...
\lstinputlisting{src/1174067/3/conmatriks.py}
\end{itemize}
\begin{figure}[H]
...
\lstinputlisting{src/1174067/3/voteforest.py}
\begin{figure}[H]
...
\hfill\break
\lstinputlisting[firstline=8, lastline=13]{src/1174067/3/1174067.py}
\begin{figure}[H]
...
\hfill\break
\lstinputlisting[firstline=16, lastline=21]{src/1174067/3/1174067.py}
\begin{figure}[H]
...
\hfill\break
\lstinputlisting[firstline=24, lastline=28]{src/1174067/3/1174067.py}
\begin{figure}[H]
...
\lstinputlisting[firstline=34, lastline=38]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/6.jpg}}
...
\lstinputlisting[firstline=42, lastline=43]{src/1174067/3/1174067.py}
\begin{figure}[H]
...
\lstinputlisting[firstline=48, lastline=48]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/10.jpg}}
\caption{Hasil 4 Bagian 4}
\label{labelgambar}
\end{figure}

\item Variabel imgatt2 head berfungsi untuk mengembalikan value teratas pada DataFrame imgatt2.
\lstinputlisting[firstline=51, lastline=51]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/11.jpg}}
\caption{Hasil 4 Bagian 5}
\label{labelgambar}
\end{figure}

\item Menghasilkan jumlah kolom dan baris pada DataFrame imgatt2.
\lstinputlisting[firstline=54, lastline=54]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/12.jpg}}
\caption{Hasil 4 Bagian 6}
\label{labelgambar}
\end{figure}

\item Menunjukkan dalam melakukan pivot yang mana imgid menjadi sebuah index yang unik.
\lstinputlisting[firstline=62, lastline=65]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/13.jpg}}
...
\lstinputlisting[firstline=68, lastline=68]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/14.jpg}}
...
\lstinputlisting[firstline=71, lastline=71]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/15.jpg}}
...
\lstinputlisting[firstline=74, lastline=75]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/16.jpg}}
\caption{Hasil 4 Bagian 10}
\label{labelgambar}
\end{figure}

\item Melakukan drop pada label yang ada didepan dan akan menggunakan label yang baru di joinkan.
\lstinputlisting[firstline=78, lastline=79]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/17.jpg}}
\caption{Hasil 4 Bagian 11}
\label{labelgambar}
\end{figure}

\item Mengecek isi 5 data teratas pada df\_att.
\lstinputlisting[firstline=82, lastline=82]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/18.jpg}}
\caption{Hasil 4 Bagian 12}
\label{labelgambar}
\end{figure}

\item Mengecek isi data teratas dari df\_label.
\lstinputlisting[firstline=85, lastline=85]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/19.jpg}}
\caption{Hasil 4 Bagian 13}
\label{labelgambar}
\end{figure}

\item Membagi 8000 row pertama menjadi data training dan sisanya adalah data testing.
\lstinputlisting[firstline=88, lastline=94]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/20.jpg}}
...
\lstinputlisting[firstline=97, lastline=98]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/21.jpg}}
\caption{Hasil 4 Bagian 15}
\label{labelgambar}
\end{figure}

\item Menunjukkan hasil prediksi dari Random Forest.
\lstinputlisting[firstline=101, lastline=101]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/22.jpg}}
...
\lstinputlisting[firstline=104, lastline=104]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/23.jpg}}
\caption{Hasil 4 Bagian 17}
\label{labelgambar}
\end{figure}

\item Menampilkan besaran akurasi dari prediksi pada Random Forest yang merupakan score perolehan klarifikasi.
\lstinputlisting[firstline=107, lastline=107]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/24.jpg}}
...
\hfill\break
\lstinputlisting[firstline=112, lastline=114]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/25.jpg}}
\caption{Hasil 5 Bagian 1}
\label{labelgambar}
\end{figure}

\lstinputlisting[firstline=117, lastline=117]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/26.jpg}}
\caption{Hasil 5 Bagian 2}
\label{labelgambar}
\end{figure}

\lstinputlisting[firstline=120, lastline=147]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/27.jpg}}
\caption{Hasil 5 Bagian 3}
\label{labelgambar}
\end{figure}

\lstinputlisting[firstline=151, lastline=154]{src/1174067/3/1174067.py}
\begin{figure}[H]
...
\lstinputlisting[firstline=158, lastline=163]{src/1174067/3/1174067.py}
\begin{figure}[H]
...
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/30.png}}
...
\hfill\break
\lstinputlisting[firstline=168, lastline=171]{src/1174067/3/1174067.py}
\begin{figure}[H]
...
\lstinputlisting[firstline=174, lastline=177]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/32.jpg}}
...
\hfill\break
\lstinputlisting[firstline=180, lastline=182]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/33.jpg}}
\caption{Hasil 7 Bagian 1}
\label{labelgambar}
\end{figure}

\lstinputlisting[firstline=185, lastline=186]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/34.jpg}}
\caption{Hasil 7 Bagian 2}
\label{labelgambar}
\end{figure}

\lstinputlisting[firstline=189, lastline=190]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/35.jpg}}
...
\hfill\break
\lstinputlisting[firstline=193, lastline=208]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/36.jpg}}
\caption{Hasil 8 Bagian 1}
\label{labelgambar}
\end{figure}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/37.jpg}}
\caption{Hasil 8 Bagian 1 Akhir kode}
\label{labelgambar}
\end{figure}

\lstinputlisting[firstline=210, lastline=224]{src/1174067/3/1174067.py}
\begin{figure}[H]
\centerline{\includegraphics[width=10cm]{figures/1174067/3/38.png}}
