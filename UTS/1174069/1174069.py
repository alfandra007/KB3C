# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 21:56:59 2020
...
def display_mfcc(song):
    ...
    plt.show()
# In[]
display_mfcc('AI/singers/Big_Bang/Bigbang - If You.mp3')
# In[]
display_mfcc('AI/singers/Day6/DAY6 - Sweet Chaos.mp3')
# In[]
...
# In[]
extract_features_song('AI/singers/Day6/DAY6 - Sweet Chaos.mp3')
# In[]
extract_features_song('AI/singers/Big_Bang/Bigbang - If You.mp3')
# In[]
def generate_features_and_labels():
    all_features = []
    all_labels = []

    singers = ['Big_Bang', 'Davichi', 'Day6', 'EXO', 'Ikon', 'IU', 'Seventeen', 'SNSD', 'Super_Junior', 'Wanna_One']
...
model.save("singers_fanny.hdf5")
# In[]
import tensorflow as tf 
model2 = tf.keras.models.load_model("singers_fanny.hdf5")
...
# In[]
predict('AI/singers/Big_Bang/Bigbang - If You.mp3')
# In[]
predict('AI/singers/Day6/DAY6 - Shoot Me.mp3')
# In[]
