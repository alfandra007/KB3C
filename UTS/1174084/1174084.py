# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 15:33:40 2020
...
# In[]:
display_mfcc('D:/New folder/KB3C/src/1174084/uts/singers/Peterpan/Walau Habis Terang.wav') #mendisplay tampilan gelombang suara 
# In[]:
display_mfcc('D:/New folder/KB3C/src/1174084/uts/singers/MaudyAyunda/Goodbye.wav')
# In[]:
...
# In[]:
extract_features_song('D:/New folder/KB3C/src/1174084/uts/singers/Peterpan/Walau Habis Terang.wav')
# In[]:
extract_features_song('D:/New folder/KB3C/src/1174084/uts/singers/MaudyAyunda/Goodbye.wav')
# In[]:
def generate_features_and_labels():
    all_features = []
    all_labels = []

    singers = ['BudiDoremi', 'DBagindas', 'HijauDaun', 'IsyanaSarasvati', 'Lyla', 'MaudyAyunda', 'Naff', 'Padi', 'Peterpan', 'Vagetoz']
    for singer in singers:
        sound_files = glob.glob('D:/New folder/KB3C/src/1174084/uts/singers/'+singer+'/*.wav') #mengembalikan array file / direktori
...
model.save("reza.singers.hdf5")
# In[]:
import tensorflow as tf 
model2 = tf.keras.models.load_model("reza.singers.hdf5")
...
# In[]:
predict('D:/New folder/KB3C/src/1174084/uts/singers/Vagetoz/Penyesalanku.wav')
# In[]:
predict('D:/New folder/KB3C/src/1174084/uts/singers/BudiDoremi/123456.wav')
# In[]:
