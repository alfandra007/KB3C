# -*- coding: utf-8 -*-
"""
Created on Wed Mar 18 21:30:11 2020
...
dataset = pd.read_csv('F:/Poltekpos/D4 TI 3C/Semester 6/Kecerdasan Buatan/Github/Upload 18 Maret 2020 github tugas 3/src/1174079/3/data.csv', sep=',')
# buat variable beriisi file csv
dataset.head() # membaca data csv
# In[1]
import numpy as np # import numpy
np.arange(1, 14, 4)	# mengatur value awal dan akhir dilompati dengan beda 4

# In[2]
import numpy as np #import library
import matplotlib.pyplot as plt #import library
mu, sigma = 2, 0.5 # Build a vector of 10000 normal deviates with variance 0.5^2 and mean 2
v = np.random.normal(mu,sigma,10000) #Mengisi histogram dengan data
...
budi = pd.read_csv("D:/Pictures/image_attribute_labels.txt",
                     sep='\s+', header=None, error_bad_lines=False, warn_bad_lines=False,
                     usecols=[0,1,2], names=['imgid', 'attid', 'present']) #Membuat variable budi untuk membaca file csv dari dataset, dengan ketentuan yang ada.

# In[4]

budi.head() #Menampilkan data yang sudah dibaca tadi tapi cuman data paling atas

# In[5]
budi.shape #Menampilkan jumlah seluruh data, kolom-nya

# In[6]
budi2 = budi.pivot(index='imgid', columns='attid', values='present') #Membuat sebuah variabel baru dari fungsi budi, dengan mengganti index menjadi kolom dan kolom menjadi index

# In[7]
budi2.head() #Menampilkan data yang sudah dibaca tadi tapi cuman data paling atas

# In[8]
budi2.shape #Menampilkan jumlah seluruh data, kolom-nya
# In[9]
imglabels = pd.read_csv("D:/Pictures/image_class_labels.txt", 
...
# In[12]
df = budi2.join(imglabels) #Varibel df dimasukkan fungsi join dari data budi2 ke variabel imglabels
...
# In[24]
birds = pd.read_csv("D:/Pictures/classes.txt",
...
plt.figure(figsize=(30,30), dpi=50) #Plot sebagai figure dengan ketentuan sizw 60,60 dan dpi 300
