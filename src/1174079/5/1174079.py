# -*- coding: utf-8 -*-
"""
Created on Mon Apr  6 08:14:25 2020
...
chandrakp_model = gensim.models.KeyedVectors.load_word2vec_format('E:/Kecerdasan Buatan/chapter 5/GoogleNews-vectors-negative300.bin', binary=True, limit=500000)

#%%
chandrakp_model['love']
#%%
chandrakp_model['faith']
#%%
chandrakp_model['fall']
#%%
chandrakp_model['sick']
#%%
chandrakp_model['clear']
#%%
chandrakp_model['shine']
#%%
chandrakp_model['bag']
#%%
chandrakp_model['car']
...
#%%
chandrakp_model['motor']
#%%
chandrakp_model['cycle']
#%%
chandrakp_model.similarity('love', 'faith')
#%%
chandrakp_model.similarity('love', 'fall')
#%%
chandrakp_model.similarity('love', 'sick')
#%%
chandrakp_model.similarity('love', 'clear')
#%%
chandrakp_model.similarity('love', 'shine')
#%%
chandrakp_model.similarity('love', 'bag')
#%%
chandrakp_model.similarity('love', 'car')
#%%
chandrakp_model.similarity('love', 'wash')
#%%
chandrakp_model.similarity('love', 'motor')
#%%
chandrakp_model.similarity('love', 'cycle')
#%% 
