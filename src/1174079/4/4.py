...
pd = pd.read_csv("F:/Poltekpos/D4 TI 3C/Semester 6/Kecerdasan Buatan/Github/Upload 30 Maret 2020 github tugas 4/src/1174079/4/csv_chandra.csv") #membaca file csv 
...
#%% Soal 3
import pandas as pd #digunakan untuk mengimport library pandas dengan alias pd
d = pd.read_csv("F:/Poltekpos/D4 TI 3C/Semester 6/Kecerdasan Buatan/Github/Upload 30 Maret 2020 github tugas 4/src/1174079/4/Youtube03-LMFAO.csv") #Membaca file csv
...
types = pd.read_csv("F:/Poltekpos/D4 TI 3C/Semester 6/Kecerdasan Buatan/Github/Upload 30 Maret 2020 github tugas 4/src/1174079/4/classes.txt",sep='\s+', header=None,usecols=[1], names=['type'])
types = types['type']
types
...
for max_features in max_features_opts:
    for n_estimators in n_estimators_opts:
        ...
        i += 1
        print("Max features: %d, num estimators: %d, accuracy: %0.2f (+/- %0.2f)" % (max_features, n_estimators, scores.mean(), scores.std() * 2))        #print hasil pengulangan yang sudah ditentukan