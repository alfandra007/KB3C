...
# In[]: No.12
    ...
    data_dir = "D:/New folder/KB3C/src/1174084/8/3DShapeNets/volumetric_data/" \
...
# In[]: No.24
                ...
                if index % 10 == 0:
                    ...
                    for i, generated_volume in enumerate(generated_volumes[:5]):
                        ...
                        voxels[voxels < 0.5] = 0.
                        voxels[voxels >= 0.5] = 1.
                        saveFromVoxels(voxels, "D:/New folder/KB3C/src/1174084/8/3DShapeNets/voxelization/results/img_{}_{}_{}".format(epoch, index, i))
...
# In[]: No.27
    ...
    if MODE == 'predict':
        ...
        for i, generated_volume in enumerate(generated_volumes[:2]):
            ...
            voxels[voxels < 0.5] = 0.
            voxels[voxels >= 0.5] = 1.
            saveFromVoxels(voxels, "D:/New folder/KB3C/src/1174084/8/3DShapeNets/voxelization/results/gen_{}".format(i))
