# -*- coding: utf-8 -*-
"""
Created on Sun Mar  1 19:56:11 2020

@author: rezas
"""
#%% Mencoba loading an example dataset
from sklearn import datasets # Untuk memanggil class datasets dari library sklearn
iris = datasets.load_iris()  # Menggunakan datasets iris
x = iris.data              # Menyimpan nilai data set iris pada variabel x
y = iris.target            # Menyimpan nilai data label iris pada variabel y    
#%%Mencoba Learning dan predicting
from sklearn.neighbors import KNeighborsClassifier #Untuk Memanggil fungsi KNeighborsClassifier
...
dump(clf, '1174084.joblib') #Menyimpan model kedalam 1174084.joblib
hasil = load('1174084.joblib') #Memanggil model 1174084
print(hasil) # Menampilkan Model yang dipanggil sebelumnya
#%% Conventions
import numpy as np # memanggil library numpy dan dibuat alias np
from sklearn import random_projection #Memanggil random_projection pada library sklean
