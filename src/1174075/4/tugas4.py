# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 19:47:25 2020
...
pd = pd.read_csv("F://Semester 6/Artificial Intelligence/Tugas 4/src/csv_sekar.csv") #membaca file csv 
...
#%% Soal 3
import pandas as izal #untuk import library pandas berguna untuk mengelola dataframe
izal = izal.read_csv("F://Semester 6/Artificial Intelligence/Tugas 4/src/Youtube03-LMFAO.csv") #membaca file dengan format csv
...
dvec = vectorizer.fit_transform(izal['CONTENT']) #untuk melakukan pemecahan data pada dataframe yang terdapat pada kolom konten
...
rf_params = izal.empty((len(max_features_opts)*len(n_estimators_opts),4), float) #rf_params sebagai variabel untuk menjumlahkan yang sudah di tentukan sebelumnya
i = 0
