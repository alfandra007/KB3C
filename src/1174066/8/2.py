# -*- coding: utf-8 -*-
"""Chapter 8 - Praktek.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12_0WmWGqqNl4ZkjsXrHHdo3t51SRGg7W
"""


#In[]:Testing Display
import scipy.io as io
voxels = io.loadmat("/content/3DShapeNets/volumetric_data/door/30/test/door_000000011_1.mat")['instance']
...
plt.show()
plt.savefig('/content/drive/My Drive/zMachine Learning/3DShape/data')
#In[]:
import glob
import os
import time
...
#In[]: Soal 12
    ...
    """
    object_name = "chair" #Membuat variable
    data_dir = "/content/3DShapeNets/volumetric_data/" \
               "{}/30/train/*.mat".format(object_name) #Memasukkan direktori dari data training
    gen_learning_rate = 0.0025 #Membuat rate pada generator
    dis_learning_rate = 10e-5 #Membuat rate pada diskriminator
    beta = 0.5 #Menentukan beta
    batch_size = 1 #Menentukan ukuran batch
    z_size = 200 #Menentukan ukuran data training
    epochs = 10 #Menentukan masa periode. setiap epoch memiliki 1 batch
    MODE = "train" #Menentukan variable isinya train
...
#In[]: Soal 16
    tensorboard = TensorBoard(log_dir="/content/drive/My Drive/zMachine Learning/3DShape/logs/{}".format(time.time()))
...
#In[]: Soal 24
                ...
                if index % 10 == 0:
                    ...
                    for i, generated_volume in enumerate(generated_volumes[:5]):
                        ...
                        voxels[voxels < 0.5] = 0.
                        voxels[voxels >= 0.5] = 1.
                        saveFromVoxels(voxels, "/content/drive/My Drive/zMachine Learning/3DShape/results/img_{}_{}_{}".format(epoch, index, i))
...
#In[]: Soal 27
    if MODE == 'predict':
        ...
        for i, generated_volume in enumerate(generated_volumes[:2]):
            ...
            voxels[voxels < 0.5] = 0.
            voxels[voxels >= 0.5] = 1.
            saveFromVoxels(voxels, "/content/drive/My Drive/zMachine Learning/3DShape/results/gen_{}".format(i))