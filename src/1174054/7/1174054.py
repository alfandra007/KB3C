# -*- coding: utf-8 -*-
"""
Created on Mon May  4 15:30:46 2020

@author: Aulyardha Anindita
"""

# In[1]:import lib
# mengimport libtary CSV untuk mengolah data ber ekstensi csv
import csv 
#kemudian mengimport library Image yang berguna untuk mengolah data berupa gambar
from PIL import Image as pil_image 
# kemudian mwngimport library keras yang menggunakan method preprocessing yang digunakan untuk membuat neural network
...
imgs = []
classes = []
#membuka file hasy-data-labels.csv yang berada di folede HASYv2 yang di inisialisasi menjadi csvfile
