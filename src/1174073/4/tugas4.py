# -*- coding: utf-8 -*-
"""
Created on Wed Mar 25 09:42:06 2020
...
rf_params = ainul.empty((len(max_features_opts)*len(n_estimators_opts),4), float) #rf_params sebagai variabel untuk menjumlahkan yang sudah di tentukan sebelumnya
i = 0
