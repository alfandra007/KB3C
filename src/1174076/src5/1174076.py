...
difa_model = gensim.models.KeyedVectors.load_word2vec_format('GoogleNews-vectors-negative300.bin', binary=True, limit=500000)
...
difa_model['cycle']
#%%
difa_model.similarity('love', 'faith')
#%%
difa_model.similarity('love', 'fall')
#%%
difa_model.similarity('love', 'sick')
#%%
difa_model.similarity('love', 'clear')
#%%
difa_model.similarity('love', 'shine')
#%%
difa_model.similarity('love', 'bag')
#%%
difa_model.similarity('love', 'car')
#%%
difa_model.similarity('love', 'wash')
#%%
difa_model.similarity('love', 'motor')
#%%
difa_model.similarity('love', 'cycle')
#%% 
