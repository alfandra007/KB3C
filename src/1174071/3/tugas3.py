...
#Variable imgatt adalah membaca file csv dari dataset, dengan ketentuan yang ada.


# In[2]:

imgatt.head() 
#untuk menampilkan data yang di baca tadi tetapi hanya data paling atas


# In[3]:

imgatt.shape 
#untuk menampilkan jumlah data, kolom


# In[4]:

imgatt2 = imgatt.pivot(index='imgid', columns='attid', values='present') 
#untuk membuat variabel baru dari fungsi imgatt, dengan mengganti index dan kolom (kebalikan)
...
#untuk baca data csv dengan ketentuan yang ada

imglabels = imglabels.set_index('imgid') 
#membuat variabel imglabels sebagai set index (imgid)
...
#membuat varibel df sebagai fungsi join dari data imgatt2 ke variabel imglabels
df = df.sample(frac=1) 
#membuat variabel df sebagai sample dengan ketentuan frac=1


# In[11]:
    
df_att = df.iloc[:, :312] #untuk membuat kolom dengan ketentuan 312
df_label = df.iloc[:, 312:] #untuk membuat kolom dengan ketentuan 312


# In[12]:

df_att.head() #untuk menampilkan data yang di baca tadi tetapi hanya data paling atas


# In[13]:

df_label.head() #untuk menampilkan data yang di baca tadi tetapi hanya data paling atas
