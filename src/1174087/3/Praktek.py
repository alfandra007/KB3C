# -*- coding: utf-8 -*-
"""
Created on Sat Mar 21 14:10:41 2020
...
biodata = {'Nama':['Ariq','Reza','Alvan'],'hobi':['Berenang','Tidur','Game'],'Umur':[17,18,19]}
#Membuat varibel yang bernama biodata, dan mengisi dataframenya dengan 3 field yaitu nama hobi dan umur
data = pd.DataFrame(biodata) # Membuat variabel data yang akan membuat DataFrame biodata mengguanakn library pandas. 
print(data) #print hasil dari data

# In[1]Numpy
import numpy as np #Melakukan import library numpy sebaaai np
matrix = np.eye(5) #Membuat sebuah matriks identitas 5x5 pake numpy dengan menggunakan fungsi eye
print(matrix) #print matrix

# In[2]Plot
import matplotlib.pyplot as pt #Melakukan import library numpy menjadi nama sendiri yaitu dirga
pt.plot([1,2,0,1,2,5,6]) #Memasukkan nilai pada plot
pt.xlabel('IlhamMuhammadAriq') #Menambahkan label pada x
pt.ylabel('1174087') #Menambahkan label pada y
pt.show() #Menampilkan grafik plot
...
# In[4]
imgatt.head() #Menampilkan data yang sudah dibaca, data paling atas
...
# In[9]
imglabels = pd.read_csv("E:/Kecerdasan Buatan/CUB_200_2011/image_class_labels.txt", 
...
# In[24]
birds = pd.read_csv("E:/Kecerdasan Buatan/CUB_200_2011/classes.txt",
