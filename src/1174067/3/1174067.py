# -*- coding: utf-8 -*-
"""
Created on Tue Mar 14 01:38:32 2020

@author: root
"""

# In[0]
import pandas as KK # Melakukan import library pandas menjadi nama sendiri yaitu KK

buah = {"Nama buah" : ['apel','ceri','boom','melon']} # Membuat varibel yang bernama aplikasi, dan mengisi dataframenya dengan nama nama aplikasi koding
x = KK.DataFrame(buah) # Membuat variabel x yang akan membuat DataFrame dari library pandas yang akan memanggil variabel aplikasi. 
print (' KK makan buah: ' + x) #print hasil dari x

# In[1]
import numpy as KK #Melakukan import library numpy menjadi nama sendiri yaitu KK

matrix_x = KK.eye(10) #Membuat sebuah matrix pake numpy dengan menggunakan fungsi eye
...
imgatt = pd.read_csv("D:/OneDrive - Hybi.god/KULIAH/Semester 6/AI/KB3C/src/1174067/3/CUB_200_2011/attributes/image_attribute_labels.txt",
...
imglabels = pd.read_csv("N:/Tugas/Kuliah/Semester 6/Kecerdasan Buatan/KB3C Ngerjain/src/1174067/3/CUB_200_2011/image_class_labels.txt", 
...
# In[24]
birds = pd.read_csv("N:/Tugas/Kuliah/Semester 6/Kecerdasan Buatan/KB3C Ngerjain/src/1174067/3/CUB_200_2011/classes.txt",
