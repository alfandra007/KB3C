# -*- coding: utf-8 -*-
"""
Created on Mon Apr  6 11:05:58 2020
...
alvan_model = gensim.models.KeyedVectors.load_word2vec_format('C:/Users/ASUS/Videos/tgsKCB/GoogleNews-vectors-negative300.bin', binary=True, limit=500000)
...
alvan_model['cycle']
#%%
alvan_model.similarity('love', 'faith')
#%%
alvan_model.similarity('love', 'fall')
#%%
alvan_model.similarity('love', 'sick')
#%%
alvan_model.similarity('love', 'clear')
#%%
alvan_model.similarity('love', 'shine')
#%%
alvan_model.similarity('love', 'bag')
#%%
alvan_model.similarity('love', 'car')
#%%
alvan_model.similarity('love', 'wash')
#%%
alvan_model.similarity('love', 'motor')
#%%
alvan_model.similarity('love', 'cycle')
#%% 
