...
biodata = {'Nama':['Alvan','Ariq','Advent'],'hobi':['Game','Nonton','Tidur'],'Umur':[20,19,21]}
...
pt.xlabel('AlvanAlvanzah') #Menambahkan label pada x
pt.ylabel('1174077') #Menambahkan label pada y
