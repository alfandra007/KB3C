...
pd = pd.read_csv("C:/Users/ASUS/Videos/zuplur/src/1174077/4/alvan.csv") #membaca file csv 
...
#%% Soal 3
import pandas as ps #untuk import library pandas berguna untuk mengelola dataframe
ps = ps.read_csv("C:/Users/ASUS/Videos/zuplur/src/1174077/4/Youtube03-LMFAO.csv") #membaca file dengan format csv
...
dvec = vectorizer.fit_transform(ps['CONTENT']) #untuk melakukan pemecahan data pada dataframe yang terdapat pada kolom konten
...
rf_params = ps.empty((len(max_features_opts)*len(n_estimators_opts),4), float) #rf_params sebagai variabel untuk menjumlahkan yang sudah di tentukan sebelumnya
i = 0
