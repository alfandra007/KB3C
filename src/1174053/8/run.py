# -*- coding: utf-8 -*-
"""
Created on Tue May 12 09:08:34 2020
...
# In[soal 9] 
def build_generator():#nama kelasnya
    """
...
if __name__ == '__main__':
    ...
    """
# In[soal  12] 
    object_name = "airplane" #membuat variabel 
    data_dir = "data/3DShapeNets/volumetric_data/" \
               "{}/30/train/*.mat".format(object_name) #menunjukan direktori dari variable sebelumnya
    gen_learning_rate = 0.0025 #membuat rate pada generator
    dis_learning_rate = 10e-5 #membuat rate pada diskriminator
    beta = 0.5 #
    batch_size = 1 #menentukan ukuran kumpulan gambar
    z_size = 200 #
    epochs = 1 #menetukkan masa periode. setiap epoch memiliki semua batch
    MODE = "train" #membuat traon mode
