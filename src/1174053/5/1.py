...
model_dini['cycle']
#%%
model_dini.similarity('wash', 'clear')
#%%
model_dini.similarity('bag', 'love')
#%%
model_dini.similarity('motor', 'car')
#%%
model_dini.similarity('sick', 'faith')
#%%
model_dini.similarity('cycle', 'shine')

#%% Soal 2
import re 
    
test_string = "Dini Permata Putri, adalah nama aku"
